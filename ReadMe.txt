...
4  查找 "Host Name" 并将 = 号后面的localhost改成本机IP地址。
5  新建环境变量 CATALINA_HOME 和 JAVA HOME。CATALINA_HOME的值为 apache-tomcat-8.0.32-windows-x64解压文件存放目录。例如C:\apache-tomcat-8.0.32-windows-x64。JAVA HOME值为jdk路径 （例如）C:\Program Files\Java\jdk1.7.0_51
